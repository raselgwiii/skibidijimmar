...
<div class="min-h-screen flex items-center justify-center bg-gradient-to-br from-emerald-400 to-cyan-500 relative overflow-hidden py-12 px-4 sm:px-6 lg:px-8">
    ...
    <div class="absolute inset-0" style="z-index: 0;">
        <!-- Large circle -->
        <div class="absolute -left-20 -top-20 w-96 h-96 rounded-full bg-white opacity-10 mix-blend-overlay"></div>
        <!-- Small circles -->
        <div class="absolute right-10 bottom-10 w-32 h-32 rounded-full bg-white opacity-10 mix-blend-overlay"></div>
        <div class="absolute left-1/4 top-1/3 w-24 h-24 rounded-full bg-white opacity-10 mix-blend-overlay"></div>
        <!-- Squares -->
        <div class="absolute right-1/3 top-1/4 w-48 h-48 -rotate-12 bg-white opacity-10 mix-blend-overlay"></div>
        <div class="absolute left-2/3 bottom-1/3 w-32 h-32 rotate-45 bg-white opacity-10 mix-blend-overlay"></div>
        <!-- Triangle using SVG -->
        <svg class="absolute right-1/4 bottom-1/4 w-32 h-32 opacity-10 rotate-180" viewBox="0 0 100 100">
        ...
        <form class="mt-8 space-y-6" action="{{ route('register') }}" method="POST">
            ...
            <div class="rounded-md shadow-sm -space-y-px">
                <div class="relative">
                    ...
                    <input id="username" name="username" type="text" required class="appearance-none rounded-none relative block w-full px-3 py-2 pl-10 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-t-md focus:outline-none focus:ring-emerald-500 focus:border-emerald-500 focus:z-10 sm:text-sm" placeholder="Username">
                ...
                <div class="relative">
                    ...
                    <input id="email" name="email" type="email" required class="appearance-none rounded-none relative block w-full px-3 py-2 pl-10 border border-gray-300 placeholder-gray-500 text-gray-900 focus:outline-none focus:ring-emerald-500 focus:border-emerald-500 focus:z-10 sm:text-sm" placeholder="Email address">
                    <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                        <svg class="h-5 w-5 text-gray-400" fill="currentColor" viewBox="0 0 20 20">
                            <path d="M2.003 5.884l7.197 4.25a1 1 0 001.6-.8V5.884a1 1 0 00-1.6-.8L2.003 9.334a1 1 0 000 1.6z" />
                        </svg>
                ...
                <div class="relative">
                    ...
                    <input id="password" name="password" type="password" required class="appearance-none rounded-none relative block w-full px-3 py-2 pl-10 border border-gray-300 placeholder-gray-500 text-gray-900 focus:outline-none focus:ring-emerald-500 focus:border-emerald-500 focus:z-10 sm:text-sm" placeholder="Password">
                    <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                        <svg class="h-5 w-5 text-gray-400" fill="currentColor" viewBox="0 0 20 20">
                ...
                <div class="relative">
                    ...
                    <input id="password_confirmation" name="password_confirmation" type="password" required class="appearance-none rounded-none relative block w-full px-3 py-2 pl-10 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-b-md focus:outline-none focus:ring-emerald-500 focus:border-emerald-500 focus:z-10 sm:text-sm" placeholder="Confirm password">
                    <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                        <svg class="h-5 w-5 text-gray-400" fill="currentColor" viewBox="0 0 20 20">
                            <path fill-rule="evenodd" d="M3 3a1 1 0 011-1h12a1 1 0 011 1v14a1 1 0 01-1 1H4a1 1 0 01-1-1V3zm10 7H7a1 1 0 000 2h6a1 1 0 000-2z" clip-rule="evenodd" />
                        </svg>
            ...
            <div>
                <button type="submit" class="group relative w-full flex justify-center py-2 px-4 border border-transparent text-sm font-medium rounded-md text-white bg-emerald-500 hover:bg-emerald-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-emerald-500">
                    ...
                    <span class="ml-2">Register Admin Account</span>
                </button>
            </div>
